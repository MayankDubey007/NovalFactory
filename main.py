...
def handle_compile(api: NovelFactoryAPI, args: argparse.Namespace):
    ...
    if getattr(args, "llm_model", None):
        api.use_llm_model(args.llm_model)
...
# ─────────────────────────────────────────────────────────────────────────────
def handle_novel_shorthand(novel_path: str, stage: str, resume: bool, model: str | None, llm_model: str | None = None):
    """
...
Full subcommand interface:
  ...
  python main.py --project ./my_project doctor
    ...
    parser.add_argument("--llm-model", type=str, default=None,
                        help="Local LLM for planning (e.g. Qwen/Qwen1.5-1.8B-Chat). "
                             "Also honored via NOVELFACTORY_LLM_MODEL env var.")
    ...
    compile_parser.add_argument("--llm-model", type=str, default=None,
                                help="Local LLM for planning (e.g. Qwen/Qwen1.5-1.8B-Chat)")
